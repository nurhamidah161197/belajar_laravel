  ...
  <div class="page-content">
    ...
    <div class="page-bar">
      <ul class="page-breadcrumb">
        ...
        <li>
          <a href="#">Administrasi Lokasi Kotak P3K</a>
        </li>
      </ul>
    </div>
    <!-- END PAGE HEADER-->
...
<script type="text/javascript">
  ...
  $('#sample_1').on('click', 'tbody tr .edit_lokasi', function(e){
     ...
     $.getJSON(APP_URL + "/lokasip3k/getlokasi/" + this.value, function(result){
