...
<link href="{{ URL::asset('admin/pages/css/login3.css') }}" rel="stylesheet" type="text/css"/>
<link href="{{ URL::asset('global/plugins/jquery-notific8/jquery.notific8.min.css') }}" rel="stylesheet" type="text/css">
...
<link href="{{ URL::asset('admin/layout/css/themes/default.css') }}" rel="stylesheet" type="text/css" id="style_color"/>
...
<div class="logo">
	<a href="javascript:;">
	<img src="{{ URL::asset('admin/layout2/img/logo-sinshe_.png') }}" alt=""/>
	</a>
</div>
<!-- END LOGO -->
	...
	<form class="login-form">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input type="hidden" name="_token" value="{{ csrf_token() }}" placeholder="Password" name="password"/>
			</div>
		</div>
...
<script src="{{ URL::asset('global/plugins/jquery-notific8/jquery.notific8.min.js') }}"></script>
...
<script src="{{ URL::asset('admin/pages/scripts/login.js') }}" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
